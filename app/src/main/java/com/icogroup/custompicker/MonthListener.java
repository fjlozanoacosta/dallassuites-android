...
public class MonthListener implements OnScrollListener{
	...
	public MonthListener(ListView lv, PickerAdapter monthAdapter, PickerAdapter dayAdapter, PickerAdapter yearAdapter) {
...
//					Log.i("MonthListener","maxDays: " + maxDays + " mes: " + monthAdapter.getMid());
